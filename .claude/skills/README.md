...
| [frontend-ui-architecture](frontend-ui-architecture/SKILL.md) | Frontend | React/Next.js project structure, colocation, component splitting, where constants/utils/business logic live |
